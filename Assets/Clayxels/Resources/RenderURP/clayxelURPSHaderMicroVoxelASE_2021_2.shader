...
Shader "Clayxels/ClayxelURPShaderMicroVoxelASE_2021_2"
{
	Properties
	{
		...
		_subsurfaceScatter("subsurfaceScatter", Float) = 0
		[ASEEnd]_subsurfaceCenter("subsurfaceCenter", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#define CLAYXELS_URP
			#pragma shader_feature CLAYXELS_UNITY_2020_2
						 ...
						 ) : SV_Target
			{
				...
				float outMetallic43 = 0;
				float outSmoothness43 = 0;
				float outDepth43 = 0;
				{
				float3 splatPos = 0;
				float outAlpha = 0;
				clayxelMicrovoxelFrag(inViewDir43, inInstanceId43, inBoundsCenter43, inBoundsSize43, inVertexId43, inVertexPos43, inScreenPos43, splatPos, outColor43, outNormal43, outEmission43, outDepth43, outAlpha, outSmoothness43, outMetallic43);
				...
				float3 Specular = 0.5;
				float Metallic = outMetallic43;
				float Smoothness = outSmoothness43;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 vertexToFrag47 = outScreenPos39;
				o.ase_texcoord4 = vertexToFrag47;
				float3 vertexToFrag44 = outBoundsCenter39;
				o.ase_texcoord3.yzw = vertexToFrag44;
				float3 vertexToFrag45 = outBoundsSize39;
				o.ase_texcoord5.xyz = vertexToFrag45;
				float3 vertexToFrag42 = outVertexPos39;
				o.ase_texcoord6.xyz = vertexToFrag42;
				float vertexToFrag69 = outInstanceId39;
				o.ase_texcoord5.w = vertexToFrag69;
						 ...
						 ) : SV_TARGET
			{
				...
				float3 outNormal43 = float3( 0,0,0 );
				float3 outEmission43 = float3( 0,0,0 );
				float inVertexId43 = (float)IN.ase_texcoord3.x;
				float4 vertexToFrag47 = IN.ase_texcoord4;
				float4 inScreenPos43 = vertexToFrag47;
				float3 vertexToFrag44 = IN.ase_texcoord3.yzw;
				float3 inBoundsCenter43 = vertexToFrag44;
				float3 vertexToFrag45 = IN.ase_texcoord5.xyz;
				float3 inBoundsSize43 = vertexToFrag45;
				float3 vertexToFrag42 = IN.ase_texcoord6.xyz;
				float3 inVertexPos43 = vertexToFrag42;
				float vertexToFrag69 = IN.ase_texcoord5.w;
				float inInstanceId43 = vertexToFrag69;
				float outMetallic43 = 0;
				float outSmoothness43 = 0;
				float outDepth43 = 0;
...
/*ASEBEGIN
Version=18921
320;219;1264;588;4499.286;436.8076;4.332571;True;False
...
Node;AmplifyShaderEditor.Vector3Node;79;-2990.326,1414.133;Inherit;False;Property;_subsurfaceCenter;subsurfaceCenter;18;0;Fetch;False;0;0;0;True;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;77;-2956.179,915.5928;Inherit;False;Property;_emissiveColor;emissiveColor;16;0;Fetch;True;0;0;0;True;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-2968.761,1155.894;Inherit;False;Property;_emissionPower;emissionPower;13;0;Fetch;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;70;-3013.969,-632.1456;Inherit;False;Property;_Metallic;Metallic;14;0;Fetch;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;43;-1382.284,103.0889;Inherit;False;float3 splatPos = 0@$float outAlpha = 0@$clayxelMicrovoxelFrag(inViewDir, inInstanceId, inBoundsCenter, inBoundsSize, inVertexId, inVertexPos, inScreenPos, splatPos, outColor, outNormal, outEmission, outDepth, outAlpha, outSmoothness, outMetallic)@$$#ifdef SHADERPASS_FORWARD$ShadowCoords = TransformWorldToShadowCoord(splatPos)@$#endif;1;Call;13;True;inViewDir;FLOAT;0;In;;Inherit;False;True;outColor;FLOAT3;0,0,0;Out;;Inherit;False;True;outNormal;FLOAT3;0,0,0;Out;;Inherit;False;True;outEmission;FLOAT3;0,0,0;Out;;Inherit;False;True;inVertexId;FLOAT;0;In;;Inherit;False;True;inScreenPos;FLOAT4;0,0,0,0;In;;Inherit;False;True;inBoundsCenter;FLOAT3;0,0,0;In;;Inherit;False;True;inBoundsSize;FLOAT3;0,0,0;In;;Inherit;False;True;inVertexPos;FLOAT3;0,0,0;In;;Inherit;False;True;inInstanceId;FLOAT;0;In;;Inherit;False;True;outMetallic;FLOAT;0;Out;;Inherit;False;True;outSmoothness;FLOAT;0;Out;;Inherit;False;True;outDepth;FLOAT;0;Out;;Inherit;False;clayxelMicroVoxelFragmentNode;False;False;0;;False;14;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;9;FLOAT3;0,0,0;False;10;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT;0;False;7;FLOAT;0;FLOAT3;3;FLOAT3;4;FLOAT3;5;FLOAT;12;FLOAT;13;FLOAT;14
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-3012.969,-531.5401;Inherit;False;Property;_Smoothness;Smoothness;15;0;Fetch;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-2993.326,1302.133;Inherit;False;Property;_subsurfaceScatter;subsurfaceScatter;17;0;Fetch;True;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;4;229,-183;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;15;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;ps4;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;3;229,-183;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;15;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;ps4;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;-960.9659,109.2975;Float;False;True;-1;2;;0;2;Clayxels/ClayxelURPShaderMicroVoxelASE_2021_2;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;15;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;ps4;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;5;Include;;False;;Native;Define;CLAYXELS_URP;False;;Custom;Custom;#pragma shader_feature CLAYXELS_UNITY_2020_2;False;;Custom;Include;../clayxelMicroVoxelUtils.cginc;False;;Custom;Custom;#define UNITY_VERTEX_INPUT_INSTANCE_ID uint instanceID : SV_InstanceID@;False;;Custom;;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;2;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;1;  Early Z;0;Vertex Position,InvertActionOnDeselection;0;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;43;6;47;0
WireConnection;43;7;44;0
WireConnection;43;8;45;0
WireConnection;43;9;42;0
WireConnection;43;10;69;0
WireConnection;2;0;43;3
WireConnection;2;1;43;4
WireConnection;2;2;43;5
WireConnection;2;3;43;12
WireConnection;2;4;43;13
WireConnection;2;17;43;14
WireConnection;2;8;39;9
ASEEND*/
//CHKSM=E05C8468A11AF35861B58226F0DCE626F6912944