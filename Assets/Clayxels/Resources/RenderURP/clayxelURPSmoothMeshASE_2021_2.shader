...
Shader "Clayxels/ClayxelURPShaderSmoothMeshASE_2021_2"
{
	Properties
	{
		...
		[HDR]_Emission1("Emission", Color) = (0,0,0,0)
		[ASEEnd]_emissionPower1("emissionPower", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float localclayxelsSmoothMesh6 = ( 0.0 );
				float3 outVertexColor6 = float3( 0,0,0 );
				int vertexIndex6 = v.ase_vertexID;
				float3 outVertexPos6 = float3( 0,0,0 );
				float3 outVertexNormal6 = float3( 0,0,0 );
				{
				clayxelVertSmoothMesh(vertexIndex6, outVertexPos6, outVertexNormal6, outVertexColor6);
				}
				
				float3 vertexToFrag9 = outVertexColor6;
				o.ase_texcoord7.xyz = vertexToFrag9;
				...
				#endif
				float3 vertexValue = outVertexPos6;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
					v.vertex.xyz = vertexValue;
				#else
					v.vertex.xyz += vertexValue;
				#endif
				v.ase_normal = outVertexNormal6;
						 ...
						 ) : SV_Target
			{
				...
				float3 vertexToFrag9 = IN.ase_texcoord7.xyz;
				
				float3 Albedo = vertexToFrag9;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( _Emission1 * _emissionPower1 ).rgb;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag9 = outVertexColor6;
				o.ase_texcoord2.xyz = vertexToFrag9;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 vertexToFrag9 = IN.ase_texcoord2.xyz;
...
/*ASEBEGIN
Version=18921
320;219;1264;588;1617.538;100.9413;1.518331;True;False
Node;AmplifyShaderEditor.VertexIdVariableNode;7;-844.4474,138.4743;Inherit;False;0;1;INT;0
Node;AmplifyShaderEditor.CustomExpressionNode;6;-643.0488,87.87054;Inherit;False;clayxelVertSmoothMesh(vertexIndex, outVertexPos, outVertexNormal, outVertexColor)@;1;Call;4;True;outVertexColor;FLOAT3;0,0,0;Out;;Inherit;False;True;vertexIndex;INT;0;In;;Inherit;False;True;outVertexPos;FLOAT3;0,0,0;Out;;Inherit;False;True;outVertexNormal;FLOAT3;0,0,0;Out;;Inherit;False;clayxelsSmoothMesh;False;False;0;;False;5;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;INT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;4;FLOAT;0;FLOAT3;2;FLOAT3;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;10;-1039.93,567.664;Inherit;False;Property;_emissionPower1;emissionPower;3;0;Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-1044.947,375.7068;Inherit;False;Property;_Emission1;Emission;2;1;[HDR];Create;False;0;0;0;True;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexToFragmentNode;9;-266.2733,3.531581;Inherit;False;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1098.267,273.3513;Inherit;False;Property;_Metallic1;Metallic;1;0;Create;False;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-774.001,394.5487;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1063.513,696.7313;Inherit;False;Property;_Smoothness1;Smoothness;0;0;Create;False;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;15;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;ps4;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;3;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;15;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;ps4;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;4;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;15;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;ps4;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;1;8;6;4
WireConnection;1;10;6;5
ASEEND*/
//CHKSM=2C952BBB96FA3B24F0EEFF3D0F5BA808B604EC07